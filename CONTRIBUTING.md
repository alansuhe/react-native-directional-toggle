...
> This project uses pnpm workspaces. Make sure you have [pnpm](https://pnpm.io/) installed globally.
...
```sh
Running "DirectionalToggleExample" with {"fabric":true,"initialProps":{"concurrentRoot":true},"rootTag":1}
```
